...
{   
    ...
    /**
     * @Route("/all", name="hotels_index", methods={"GET"})
     */
    public function hotelsindex(HotelRepository $hotelRepository): Response
    {
        return $this->render('/home/hotel/hotel.html.twig', [
